...
2. `references/shiny-sample.png` — TEXTURE + GRID anchor (the user-approved **abstract color-block square rhinestone-studded sample**: square-cut crystal studs in a regular square grid, strong mirror highlights and star glints, fixed bead size/count/placement, full dreamy composition, NO concrete subject).
